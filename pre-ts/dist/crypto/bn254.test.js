...
describe("Bn254 wrapper", () => {
    test("pow", async () => {
        let Z = BN254CurveWrapper.pairing(BN254CurveWrapper.G1Generator(), BN254CurveWrapper.G2Generator());
        ...
        const expectedBytes = BN254CurveWrapper.GTToBytes(BN254CurveWrapper.gtPow(scheme.Z, randomScalar));
